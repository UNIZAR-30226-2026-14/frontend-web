...
const ItemIcon = ({ id, color = "currentColor", size = 50 }) => {
  const icons = {
    plus4: (
      /* Reducimos escala para que quepa el alto de 160 en 100 */
    ...
    guardianAngel: (
      /* Estaba en coordenadas negativas, lo bajamos al centro */
    ...
    swap: (
      /* Escalamos un poco para que no quede pegado a los bordes */
